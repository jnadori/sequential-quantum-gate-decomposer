...
*/
class NV_Decomposition : public Optimization_Interface {
...
@return An instance of the class
*/
NV_Decomposition( Matrix Umtx_in, int qbit_num_in, int level_limit_in, int level_limit_min_in, std::map<std::string, Config_Element>& config, int accelerator_num=0 );
...
@return An instance of the class
*/
NV_Decomposition( Matrix Umtx_in, int qbit_num_in, int level_limit_in, int level_limit_min_in, std::vector<matrix_base<int>> topology_in, std::map<std::string, Config_Element>& config, int accelerator_num=0 );
...
*/
void add_nv_layers( Gates_block* gate_structure );

/**
@brief Call to construct adaptive layers.
*/
Gates_block* construct_nv_gate_layers();
